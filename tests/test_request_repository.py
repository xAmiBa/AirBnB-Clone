...
def test_get_all_requests(db_connection):
    ...
    assert all_requests == [Request(1, 1,3, '12/12/23',False), \
                            Request(2, 2,2,'03/08/23',False)]
...
def test_get_request_for_user(db_connection):
    ...
    assert new_repository.get_requests_for_user(2) == [Request(2,2,2,'03/08/23',False)]